...
/* Le reste du contenu à droite de l'arrière-plan */
.content {
  width: 50%; /* L'autre moitié de la largeur de l'écran */
  height: 100%; /* Couvrira toute la hauteur de la page */
  float: left; /* Flotte à gauche pour occuper la moitié droite */
}
